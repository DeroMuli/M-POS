...
public class UpdateName extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar)findViewById(R.id.updatename_toolbar);
    ...
    public void UpdateName(View view){
        EditText newnameedit = (EditText)findViewById(R.id.new_name);
        String newname = newnameedit.getText().toString();
        ContentValues values = new ContentValues();
        values.put(UpdateActivity.type,"pname");
        values.put(UpdateActivity.var,newname);
    ...
    private class SeTUpSpinner extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            product_spinner = (Spinner)findViewById(R.id.old_name_spinner);
